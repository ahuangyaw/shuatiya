package asia.huangzhitao.shuatiya.controller;

import asia.huangzhitao.shuatiya.annotation.AuthCheck;
import asia.huangzhitao.shuatiya.common.BaseResponse;
import asia.huangzhitao.shuatiya.common.DeleteRequest;
import asia.huangzhitao.shuatiya.common.ErrorCode;
import asia.huangzhitao.shuatiya.common.ResultUtils;
import asia.huangzhitao.shuatiya.constant.UserConstant;
import asia.huangzhitao.shuatiya.exception.BusinessException;
import asia.huangzhitao.shuatiya.exception.ThrowUtils;
import asia.huangzhitao.shuatiya.model.dto.questionBank.QuestionBankQueryRequest;
import asia.huangzhitao.shuatiya.model.dto.questionBankQuestion.QuestionBankQuestionAddRequest;
import asia.huangzhitao.shuatiya.model.dto.questionBankQuestion.QuestionBankQuestionQueryRequest;
import asia.huangzhitao.shuatiya.model.dto.questionBankQuestion.QuestionBankQuestionRemoteRequest;
import asia.huangzhitao.shuatiya.model.dto.questionBankQuestion.QuestionBankQuestionUpdateRequest;
...
public class QuestionBankQuestionController {
     ...
     * 删除题库
     *
     * @param questionBankQuestionRemoteRequest
     * @return
     */
    @PostMapping("/remote")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> remoteQuestionBankQuestion(@RequestBody QuestionBankQuestionRemoteRequest questionBankQuestionRemoteRequest) {
        ThrowUtils.throwIf(questionBankQuestionRemoteRequest == null, ErrorCode.PARAMS_ERROR);
        Long questionBankId = questionBankQuestionRemoteRequest.getQuestionBankId();
        Long questionId = questionBankQuestionRemoteRequest.getQuestionId();
